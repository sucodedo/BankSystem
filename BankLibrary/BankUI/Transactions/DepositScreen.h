...
public:
    ...
    {
        DepositScreen::_ScreenHeader("\t\tDeposit Screen");
        ...
        double Amount = InputValidate::input_Db_Number("Enter The Amount That You Want To Deposit: ", "Try Again!");
        
        if (Amount > 0)
        {
            char AskForDeposit = InputValidate::ReadChar("Are you sure you want tp perform this transaction y/n?: ");
            ...
            if (AskForDeposit == 'y' || AskForDeposit == 'Y')
            {
                ...
                cout << "Deposit was cancelled" << endl;
        }
    }
};